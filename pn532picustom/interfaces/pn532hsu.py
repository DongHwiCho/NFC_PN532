...
from .pn532Interface import Pn532Interface, PN532_PREAMBLE, PN532_STARTCODE1, PN532_STARTCODE2, PN532_HOSTTOPN532, \
    PN532_POSTAMBLE, PN532_TIMEOUT, PN532_INVALID_FRAME, PN532_PN532TOHOST, PN532_INVALID_ACK, \
    PN532_ACK_WAIT_TIME
from ..nfc.pn532_log import DMSG, DMSG_HEX
...
class Pn532Hsu(Pn532Interface):
    ...
    def __init__(self, port: str):
        ...
        self._serial = Serial(str(port), baudrate=115200, timeout=100)
        self._serial.close()
        self.command = 0
